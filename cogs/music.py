...
class ReswanBot(commands.Cog):
    ...
    async def play(self, ctx, *, query):
        ...
        # --- PERBAIKAN BUG: Mengubah pola URL Spotify agar cocok dengan URL asli ---
        if self.spotify and ("http://googleusercontent.com/spotify.com/track/" in query or "http://googleusercontent.com/spotify.com/playlist/" in query or "http://googleusercontent.com/spotify.com/album/" in query): 
            is_spotify_link = True
            try:
                if "http://googleusercontent.com/spotify.com/track/" in query:
                ...
                elif "http://googleusercontent.com/spotify.com/playlist/" in query:
                    ...
                    for item in results['items']:
                        ...
                        if track: 
                            search_query = f"{track['name']} {track['artists'][0]['name']}"
                            urls.append(search_query)
                elif "http://googleusercontent.com/spotify.com/album/" in query:
